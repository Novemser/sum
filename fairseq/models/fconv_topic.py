...
def get_archs():
    return [
        'fconv_topic', 'fconv_topic_giga', 'fconv_topic_giga_test' ,
        'fconv_topic_iwslt_de_en', 'fconv_topic_wmt_en_ro', 'fconv_topic_wmt_en_de', 
        'fconv_topic_wmt_en_fr', 'fconv_topic_giga_large',
...
def parse_arch(args):
    ...
    if args.arch == 'fconv_topic_iwslt_de_en':
        ...
        args.decoder_out_embed_dim = 512
    elif args.arch == 'fconv_topic_wmt_en_fr':
