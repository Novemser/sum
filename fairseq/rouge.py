...
if __name__ == '__main__':
  summary = [
              "levi strauss jeans and <unk> jeans",
              "the first earth day on the earth day",
              "asean to form free trade area in asean summit",
              "india ready to discuss all outstanding issues in kashmir",
              "beckham to make playing debut in new york",
              "ge to clean up <unk> plant in us",
              "head of zoe 's ark arrives in france",
              "new discovery of <unk> t. rex",
              "security council extends mandate of multinational force in iraq",
              "former deputy director says bolton 's effort to oust analyst"
              ]
  reference = [
